...
BIRTHDAY_VOICE_NOTIFY_GUILD = os.getenv("BIRTHDAY_VOICE_NOTIFY_GUILD")
BIRTHDAY_MEMBER_COUNT_THRESHOLD = os.getenv("BIRTHDAY_MEMBER_COUNT_THRESHOLD")
...
config = {
    ...
    "BIRTHDAY_VOICE_NOTIFY_GUILD":BIRTHDAY_VOICE_NOTIFY_GUILD,
    "BIRTHDAY_MEMBER_COUNT_THRESHOLD":BIRTHDAY_MEMBER_COUNT_THRESHOLD
}
